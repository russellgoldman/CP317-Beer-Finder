...
## Inspiration:
Inspiration:
Have you ever had an idea of what kind of beer you wanted, maybe an American Pale Ale with a medium alcohol content, but you didn’t know what brand would be best linked to your criteria?
...
* JS is responsible for furhter manipulation of the HTML Document Object Model (DOM) that cannot be handed by Jinja
